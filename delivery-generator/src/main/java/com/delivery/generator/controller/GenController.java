package com.delivery.generator.controller;
...
import com.delivery.common.core.domain.CxSelect;
...
import com.delivery.common.utils.security.PermissionUtils;
import com.delivery.generator.domain.GenTable;
import com.delivery.generator.domain.GenTableColumn;
import com.delivery.generator.service.IGenTableColumnService;
...
public class GenController extends BaseController {
	...
	private void genCode(HttpServletResponse response, byte[] data) throws IOException {
		response.reset();
		response.setHeader("Content-Disposition", "attachment; filename=\"delivery.zip\"");
