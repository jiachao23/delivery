...
var wsocket;
var width = parseInt(70 * (203 / 25.4) + 0.5);//标签宽度104mm转dot，打印机分辨率203dpi(dots per inch)
var height = parseInt(50 * (203 / 25.4) + 0.5);//标签高度75mm转dot，打印机分辨率203dpi
var wsserver = "ws://127.0.0.1:1808/";
let isConnectPrinter;
let isPrinterDriverOk = true;
let titleSize = 53;
let contentSize = 35;
        ...
        operate: {
            ...
            successTabCallback: function (result) {
                if (result.code == web_status.SUCCESS) {
                    ...
                    var $contentWindow = $('.Delivery_iframe[data-id="' + currentId + '"]', topWindow)[0].contentWindow;
                    $.modal.close();
