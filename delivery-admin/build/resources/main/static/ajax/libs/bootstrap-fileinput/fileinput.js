...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initUploadSuccess: function (out, $thumb, allFiles) {
            var self = this, append, data, index, $div, $newCache, content, config, tags,
                i;
        ...
        _uploadBatch: function () {
            var self = this, fm = self.fileManager, total = fm.total(), params = {},
                ...
                fnComplete,
                hasPostData = total > 0 || !$.isEmptyObject(self.uploadExtraData), errMsg,
